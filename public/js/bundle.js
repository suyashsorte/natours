...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    ...
    scrollZoom: false // center: [-118.122063, 34.099173],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend map bounds to include curr loc
...
var stripe = Stripe('pk_test_51GsCwlJIO0ERPhyTStQFjSvJzy7PF7G8FvfaMkBsX2FNu9ToBI7Pf1UbyJ5SsqhURWlSJM9ndjBt4z8pdZ14zJvH00YHC7ebGf');
...
if (_alerts.alert) showAlert('success', alertMessage, 20);

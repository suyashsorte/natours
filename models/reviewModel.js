...
// to store all the changed data in r
...
// to update bycalling calcaveragerating and passing tour id
reviewSchema.post(/^findOneAnd/, async function () {
  // await this.findOne() does not work here as the query has already executed
  await this.r.constructor.calcAverageRatings(this.r.tour); //r.tour contains tour id
});
